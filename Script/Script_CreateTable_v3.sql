...
CREATE TABLE FIRMAINCLOUD.UTENZE (  
	...
	KEY_LOC 	INT,				-- Chiave tabella località
	
	SST 		VARCHAR(10),			-- Toponimo
	STRADA 		VARCHAR(80),			-- Strada 	
	NCN 		VARCHAR(3),				-- numero civico	                                                       	

	KEY_NAZ_NAS 	INT,				-- Chiave tabella nazioni  nascita
	KEY_REG_NAS 	INT,				-- Chiave tabella regioni  nascita
	KEY_PRO_NAS 	INT,				-- Chiave tabella province nascita
	KEY_COM_NAS 	INT,				-- Chiave tabella comuni   nascita
	KEY_LOC_NAS 	INT,				-- Chiave tabella località nascita
	...
	KEY_DOC		INT					-- Chiave tabella documento
);
...
CREATE TABLE FIRMAINCLOUD.TEMPLATEXML (
...
CREATE TABLE FIRMAINCLOUD.RESERVATION (
    ID INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE FIRMAINCLOUD.GUESTS (
	ID INT(11) NOT NULL AUTO_INCREMENT,
    PMSID VARCHAR(256) NOT NULL,
...
CREATE TABLE FIRMAINCLOUD.DOCUMENT (
	KEY_DOC 	INT AUTO_INCREMENT,
	TYP_DOC 	VARCHAR(1) NOT NULL, 
	NUM_DOC		VARCHAR(80) NOT NULL, 
	ISS_DOC 	VARCHAR(12),
	CITY_DOC 	VARCHAR(1),
	PRIMARY KEY(KEY_DOC)
);

CREATE TABLE FIRMAINCLOUD.VERSIONSW (
	KEY_VER 	INT AUTO_INCREMENT,
	NOTE_VER 	VARCHAR(1),  
	ISS_DOC 	VARCHAR(12),
	PRIMARY KEY(KEY_VER)
);
