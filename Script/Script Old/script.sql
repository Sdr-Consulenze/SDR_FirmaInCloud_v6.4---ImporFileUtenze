...
VALUES 
(1,'al trattamento di particolari categorie di dati personali (sensibili), per le finalità e nei limiti indicati dalla menzionata informativa',NULL),
(1,'al trattamento delle mie immagini o video, per le finalità e nei limiti indicati dalla menzionata informativa',NULL),
(1,'al trattamento dei miei dati personali per finalità di marketing e pubblicità nei limiti indicati dalla menzionata informativa',NULL);
